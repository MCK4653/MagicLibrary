...
/**
 * <p> Esta es la clase para manejar las entidades de tipo Book (libro) {@link edu.gitt.is.magiclibrary.model.entities.Book} y est� codificada usando la API JPA {@link javax.persistence}</p>
 ...
 * @return Libro {@link java.util.Optional} Relleno con el libro si se encontraba, o vac�o si no estaba
 */
